...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //数据库连接地址
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/1707f_qhd?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        //驱动类 名称
        ...
        //包含那些表
        strategyConfig.setInclude("lx_good","lx_sales","lx_goods_sales");
